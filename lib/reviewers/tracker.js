...
function TrackerProcessor(project, reviewer) {
...
TrackerProcessor.prototype = {
    ...
    stories.forEach(function(s) {
      if (pr.state == "open") {
        p.push(self.getReviewLabel().then(function(label) {
          return self.markStoryDelivered(label, s)
        }));
      } else if (pr.state == "merged") {
        p.push(self.markStoryAccepted(s));
        p.push(self.reviewer.redis.sremAsync("pull-requests", pr.number));
      }
    });
  ...
  markStoryDelivered: function(label, id) {
    var self = this;
    return self.project.story(id).getAsync().then(function(story) {
  ...
  markStoryAccepted: function(label, id) {
    var self = this;
    return self.project.story(id).getAsync().then(function(story) {
